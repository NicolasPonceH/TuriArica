...
import { Mountain, Settings, Database, Heart } from 'lucide-react';
...
export default function Footer() {
  ...
  return (
    <footer className="bg-surface-900 py-12 text-center border-t border-gray-200">
      ...
      <div className="text-sm font-medium text-slate-500 mb-4 flex items-center justify-center gap-1">
        <span>Desarrollado con</span>
        <Heart className="w-3.5 h-3.5 text-rose-500 fill-rose-500 inline" aria-label="amor" />
        <span>para Arica, Chile · 2026</span>
      </div>
