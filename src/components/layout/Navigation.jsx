              ...
              {langOpen && (
                ...
                >
                  {SUPPORTED_LANGUAGES.map(lang => (
                    ...
                    >
                      <span className="w-6 h-5 rounded-md flex items-center justify-center text-[10px] font-black uppercase tracking-wider bg-slate-100 text-slate-700 shrink-0">
                        {lang.shortCode || lang.code.toUpperCase()}
                      </span>
