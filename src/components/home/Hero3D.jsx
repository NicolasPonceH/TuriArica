...
function VideoBackground() {
  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden bg-black">
      ...
      />
      {/* Scrim direccional optimizado para legibilidad tipográfica sobre video aéreo */}
      <div className="absolute inset-0 bg-gradient-to-r from-white/90 via-white/70 to-transparent/20 dark:from-slate-950/92 dark:via-slate-950/75 dark:to-transparent/20 pointer-events-none"></div>
      <div className="absolute inset-0 bg-gradient-to-t from-white/30 via-transparent to-black/20 pointer-events-none"></div>
    </div>
  );
}
    ...
    <section id="inicio" className="relative min-h-[90vh] sm:h-screen w-full overflow-hidden flex items-center">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 pt-32 sm:pt-36 lg:pt-40 pb-16 flex flex-col items-start text-left">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-slate-900 dark:text-slate-100 font-semibold leading-relaxed max-w-xl mb-8 sm:mb-9 drop-shadow-[0_1px_3px_rgba(255,255,255,0.9)] dark:drop-shadow-[0_1px_4px_rgba(0,0,0,0.8)]">
            {t('hero.subtitle')}
          </p>
